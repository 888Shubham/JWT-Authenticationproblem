...
export const loginUser = (req, res) => {
  ...
  if (status) {
    ...
    const token = jwt.sign({userId: status.id, email: status.email},'nazUrlQi6WnlKoFs2u4mDRwBJf2ImzcO',{expiresIn :'1h',});
    res
      .status(201).cookie("jwtToken", token, { maxAge: 900000, httpOnly: false })
